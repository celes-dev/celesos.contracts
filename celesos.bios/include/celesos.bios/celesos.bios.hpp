...
namespace celesos {
   ...
   class [[eosio::contract("celesos.bios")]] bios : public eosio::contract {
      public:
         ...
         [[eosio::action]]
         void newaccount( eosio::name             creator,
                          eosio::name             name,
         ...
         [[eosio::action]]
         void updateauth(  ignore<eosio::name>  account,
                           ignore<eosio::name>  permission,
                           ignore<eosio::name>  parent,
                           ignore<authority> auth ) {}

         [[eosio::action]]
         void deleteauth( ignore<eosio::name>  account,
                          ignore<eosio::name>  permission ) {}

         [[eosio::action]]
         void linkauth(  ignore<eosio::name>    account,
                         ignore<eosio::name>    code,
                         ignore<eosio::name>    type,
                         ignore<eosio::name>    requirement  ) {}

         [[eosio::action]]
         void unlinkauth( ignore<eosio::name>  account,
                          ignore<eosio::name>  code,
                          ignore<eosio::name>  type ) {}
         ...
         [[eosio::action]]
         void setpriv( eosio::name account, uint8_t is_priv ) {
            require_auth( _self );
            set_privileged( account.value, is_priv );
         }

         [[eosio::action]]
         void setalimits( eosio::name account, int64_t ram_bytes, int64_t net_weight, int64_t cpu_weight ) {
            require_auth( _self );
         ...
         [[eosio::action]]
         void setabi( eosio::name account, const std::vector<char>& abi ) {
