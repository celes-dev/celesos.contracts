...
struct [[ eosio::table("abihash"), eosio::contract("celesos.system") ]] abi_hash
{
   name owner;
...
/*
    ...
    */
class[[eosio::contract("celesos.system")]] native : public eosio::contract
{
 public:
   ...
   [[eosio::action]] void canceldelay(ignore<permission_level> canceling_auth, ignore<capi_checksum256> trx_id) {}
