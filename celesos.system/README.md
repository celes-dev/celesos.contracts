...
## celesos.system::cfgproducer    account config
...
## celesos.system::okproducer     account producer vote
...
## celesos.system::setproxy       account proxy
...
## celesos.system::unstake        account quantity 
...
## celesos.system::withdraw account
   - this action can only be triggered by celesos.system via a deferred transaction generated by unstake
   - this will generate an inline celes.token::transfer call from=celesos.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## celesos.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## celesos.system::stakevote account amount
...
## celesos.system::onblock   account blocktime blocknum
...
## celesos.system::freeze producer accounts true|false 
...
## celesos.system::paystandby producer
