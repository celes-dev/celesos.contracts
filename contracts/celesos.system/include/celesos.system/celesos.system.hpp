...
namespace celesossystem {
   ...
   /**
    *
    * @defgroup celesossystem celesos.system
    * @ingroup eosiocontracts
    * celesos.system contract defines the structures and actions needed for blockchain's core functionality.
   ...
   struct [[eosio::table("global"), eosio::contract("celesos.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      EOSLIB_SERIALIZE_DERIVED( eosio_global_state, eosio::blockchain_parameters,
                                ...
                                (last_producer_schedule_block)(total_unpaid_blocks)
                                (last_producer_schedule_size)(last_name_close)
                                (total_unpaid_block_fee)(total_unpaid_wood)(is_network_active)(active_touch_count)(last_account)
                                (network_active_block)(total_wood)(total_dbp_count)(is_dbp_active)(dbp_active_block) )
   };
   ...
   struct [[eosio::table, eosio::contract("celesos.system")]] producer_info {
      ...
      double   by_votes()const    { return is_active ? -valid_woods : valid_woods;  }
      bool     active()const      { return is_active;                               }
      void     deactivate()       { producer_key = public_key(); is_active = false; }

      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE( producer_info, (owner)(valid_woods)(producer_key)(is_active)(url)
                        (unpaid_blocks)(last_claim_time)(location)(unpaid_block_fee)(unpaid_wood) )
   };
   ...
   struct [[ eosio::table, eosio::contract("celesos.system") ]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE(voter_info, (owner)(proxy)(producers)(voted)(is_proxy)(flags1)(reserved2)(reserved3))
   };

   struct [[ eosio::table, eosio::contract("celesos.system") ]] wood_burn_info { // wood burn detail

      uint64_t rowid = 0;
      eosio::name voter; /// the voter
   ...
   struct [[ eosio::table, eosio::contract("celesos.system") ]] wood_burn_producer_block_stat { //  wood burn per bp and block stat(木头焚烧按照BP及block_number统计的表)
      ...
      uint64_t rowid = 0;
      eosio::name producer; /// the producer
      uint32_t block_number = 0;
      uint32_t stat = 0;

      uint64_t primary_key() const { return rowid; }

      static uint128_t bpblockkey(eosio::name producer, uint32_t block_number) {
        return (uint128_t)producer.value << 32 | block_number;
      }
      
      uint128_t get_producer_block() const { 
         return bpblockkey(producer, block_number); 
         }
   ...
   struct [[eosio::table, eosio::contract("celesos.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
    ...
    */
   struct [[eosio::table, eosio::contract("celesos.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("celesos.system")]] refund_request {
      name            owner;
    ...
    */
   struct [[eosio::table,eosio::contract("celesos.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
    ...
    */
   struct [[eosio::table,eosio::contract("celesos.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
    ...
    */
   struct [[eosio::table,eosio::contract("celesos.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
    ...
    */
   struct [[eosio::table,eosio::contract("celesos.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("celesos.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
   ...
   class [[eosio::contract("celesos.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name saving_account{"celes.saving"_n};
         static constexpr eosio::name rex_account{"celes.rex"_n};
         static constexpr eosio::name null_account{"celes.null"_n};
          ...
          */
         [[eosio::action]]
         void voteproducer( const eosio::name voter_name, const eosio::name wood_owner_name, std::string wood,
                                        const uint32_t block_number, const eosio::name producer_name);
          ...
          */
         [[eosio::action]]
         void regproxy( const eosio::name& proxy, bool isproxy );
          ...
          */
         [[eosio::action]]
         void setpriv( const eosio::name& account, uint8_t is_priv );
          ...
          */
         [[eosio::action]]
         void rmvproducer( const eosio::name& producer );
          ...
          */
         [[eosio::action]]
         void bidname( const eosio::name& bidder, const eosio::name& newname, const asset& bid );
          ...
          */
         [[eosio::action]]
         void bidrefund( const eosio::name& bidder, const eosio::name& newname );

         /**
          * Register dbp action.
          *
          * @details Register dbp action, indicates that a particular account wishes to become a producer,
          * this action will create a `dbp_info` object for `dbp` scope
          * in dbps tables.
          *
          * @param dbpname - account registering to be a dbp candidate,
          * @param url - the url of the block producer, normally the url of the dapp producer presentation website,
          * @param steemid - the dbp's steemid
          *
          * @pre dbp is not already registered
          * @pre Producer to register is an account
          * @pre Authority of producer to register
          */
         [[eosio::action]] void regdbp(const eosio::name dbpname, std::string url, std::string steemid);

         /**
          * Unregister dbp action.
          *
          * @details Deactivate the dapp with account name `producer`.
          * @param dbpname - the dapp producer account to unregister.
          */
         [[eosio::action]] void unregdbp(const eosio::name dbpname);

         /**
          * limit dp to claim rewards.
          *
          * @details limit dp to claim rewards..
          * @param namelist - the bps name list.
          */
         [[eosio::action]]
         void limitbps(const std::vector<eosio::name>& namelist);

        /**
          * unlimit dp to claim rewards.
          *
          * @details unlimit dp to claim rewards..
          * @param namelist - the bps name list.
          */
         [[eosio::action]]
         void unlimitbp(const eosio::name &owner_name);

         /**
          * active the dbp
          *
          * @details active the dbp.
          */
         [[eosio::action]]
         void activedbp();
          ...
          * upate name list
          *
          * @details upate name list(whitle/gray/black)
          * @param list_type - the list type(white/gray/black).
          * @param action_type - the action type(add/remobe)
          * @param namelist - the name list.
          */
         [[eosio::action]]
         void setnamelist(uint8_t list_type, uint8_t action_type, const std::vector<eosio::name>& namelist );

         [[eosio::action]]
         void setproxy(const eosio::name voter_name, const eosio::name proxy_name);
         ...
         using regdbp_action = eosio::action_wrapper<"regdbp"_n, &system_contract::regdbp>;
         using unregdbp_action = eosio::action_wrapper<"unregdbp"_n, &system_contract::unregdbp>;
         using limitbps_action = eosio::action_wrapper<"limitbps"_n, &system_contract::limitbps>;
         using unlimitbp_action = eosio::action_wrapper<"unlimitbp"_n, &system_contract::unlimitbp>;
         using activedbp_action = eosio::action_wrapper<"activedbp"_n, &system_contract::activedbp>;
         using setnamelist_action = eosio::action_wrapper<"setnamelist"_n, &system_contract::setnamelist>;
         using setproxy_action = eosio::action_wrapper<"setproxy"_n, &system_contract::setproxy>;
      ...
      private:
         ...
         bool verify(const std::string wood, const uint32_t block_number, const eosio::name wood_owner_name);
         ...
         void update_vote(const eosio::name voter_name, const eosio::name wood_owner_name,
                     const std::string wood, const uint32_t block_number, const eosio::name producer_name);

         void ramattenuator();
         void ramattenuator(eosio::name account);
   ...
   /** @}*/ // end of @defgroup celesossystem celesos.system
} /// celesossystem
