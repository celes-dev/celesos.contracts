...
namespace celes {
   ...
   /**
    * @defgroup eosiotoken celes.token
    * @ingroup eosiocontracts
    *
    * celes.token contract
    *
    * @details celes.token contract defines the structures and actions that allow users to create, issue, and manage
    * tokens on eosio based blockchains.
    * @{
    */
   class [[eosio::contract("celes.token")]] token : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiotoken celes.token
} /// namespace eosio
