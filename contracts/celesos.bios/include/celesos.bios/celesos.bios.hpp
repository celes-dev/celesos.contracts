...
namespace celesos {
   ...
   /**
    * @defgroup eosiobios celes.bios
    * @ingroup eosiocontracts
    *
    * celes.bios is a minimalistic system contract that only supplies the actions that are absolutely
    * critical to bootstrap a chain and nothing more.
    *
    * @{
    */
   class [[eosio::contract("celesos.bios")]] bios : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiobios celes.bios
} /// namespace eosio
