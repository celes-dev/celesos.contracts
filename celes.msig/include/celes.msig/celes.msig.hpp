...
namespace celes {
   ...
   class [[eosio::contract("celes.msig")]] multisig : public eosio::contract {
      public:
         using contract::contract;

         [[eosio::action]]
         void propose(eosio::ignore<eosio::name> proposer, eosio::ignore<eosio::name> name,
               eosio::ignore<std::vector<eosio::permission_level>> requested, eosio::ignore<eosio::transaction> trx);
         [[eosio::action]]
         void approve( eosio::name proposer, eosio::name name, eosio::permission_level level,
                       const eosio::binary_extension<eosio::checksum256>& proposal_hash );
         [[eosio::action]]
         void unapprove( eosio::name proposer, eosio::name name, eosio::permission_level level );
         [[eosio::action]]
         void cancel( eosio::name proposer, eosio::name name, eosio::name canceler );
         [[eosio::action]]
         void exec( eosio::name proposer, eosio::name name, eosio::name executer );
         [[eosio::action]]
